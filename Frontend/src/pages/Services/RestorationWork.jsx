...
import Work1 from "../../assets/be.jpg";
import Work2 from "../../assets/pg1.jpg";
import Work3 from "../../assets/pg2.jpg";
import Work4 from "../../assets/pg3.jpg";
import Work5 from "../../assets/ep1.jpg";
import Work6 from "../../assets/ep2.jpg";
import Work7 from "../../assets/wp1.jpeg";
import Work8 from "../../assets/wp2.jpeg";
import Work9 from "../../assets/wp3.jpg";

const projects = [
  { title: "Building Envelope", subtitle: "Ensuring structural integrity and energy efficiency.", images: [Work1] },
  { title: "Parking Garage", subtitle: "Comprehensive restoration for long-term durability.", images: [Work2, Work3, Work4] },
  { title: "Exterior Painting", subtitle: "Comprehensive restoration for long-term durability.", images: [Work5, Work6] },
  { title: "Water Proofing", subtitle: "Hot Applied & Cold Applied Water proofing.", images: [Work7, Work8, Work9] },
];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {projects.map((project, index) => (
            ...
            >
              ...
              />
              <div className="pt-2 px-4 tracking-wider text-xl uppercase font-bold text-gray-800 bg-white transition duration-300 group-hover:bg-yellow-500 group-hover:text-white">
                {project.title}
              </div>
              <div className="pb-2 px-4 tracking-wider text-md font-medium text-gray-800 bg-white transition duration-300 group-hover:bg-yellow-500 group-hover:text-white">
                {project.subtitle}
              </div>
            </motion.div>
          ))}
